...
namespace common\components\widgets\controllers;

use common\components\widgets\menuUpdate\models\MenuX;
...
class WidgetController extends MainController
{
    ...
    public function actionMenuxModalOpenMenuUpdate($id, $menu_id, $nodeAction){
        ...
        if (isset($model)){
            ...
            return $this->renderAjax('@common/components/widgets/menuUpdate/views/_form_menu', [
                'model' => $model,
                'routes' => $routes,
